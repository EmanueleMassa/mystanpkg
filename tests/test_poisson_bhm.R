...
source("glm.bhm.R")
tic()
fit <- glm_bhm(Y, X, group, family = "poisson", seed = 123, var_meta_mean = 10, var_meta_var = 2.5)
toc()
...
tic()
fit2 <- glm_abhm(y, x, historical_data = data_fits, family = "poisson", seed = 123, var_meta_mean = 10, var_meta_var = 2.5)
toc()
fit2
fit
